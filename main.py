...
def main():
    ...
    if os.path.exists("ML_Project_image_text_detection/model.h5"): #fix 
        print("helo")
        model = load_model("ML_Project_image_text_detection/model.h5") #fix 
        LB = joblib.load("ML_Project_image_text_detection/label_binarizer.pkl") #fix
